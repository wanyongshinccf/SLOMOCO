...
# define variables
d2r  = 0.01745329
iTD_mean  = np.zeros((int(tdim),1))
iTDz_mean = np.zeros((int(tdim),1))
ioTD_mean = np.zeros((int(tdim),1))
iTD_max  = np.zeros((int(tdim),1))
iTDz_max = np.zeros((int(tdim),1))
ioTD_max = np.zeros((int(tdim),1))
npix = 6
