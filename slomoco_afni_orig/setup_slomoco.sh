...
export PESTICA_DIR=/tools/pestica_afni_v5.51    # set the one you use pestica5.51
# export PESTICA_DIR=/mnt/netScratch/wyshin/SWdevelopment/pestica_afni_v5.51
# export PESTICA_DIR=/Users/wanyongshin/SWdevelopment/pestica_afni_v5.51      
export SLOMOCO_DIR=/tools/slomoco_afni_v5.52
# export SLOMOCO_DIR=/mnt/netScratch/wyshin/SWdevelopment/slomoco_afni_v5.52
# export SLOMOCO_DIR=/Users/wanyongshin/SWdevelopment/slomoco_afni_v5.52

export MATLAB_AFNI_DIR=$PESTICA_DIR/afni_matlab
export MATLAB_PESTICA_DIR=$PESTICA_DIR/pestica_matlab
export MATLAB_SLOMOCO_DIR=$SLOMOCO_DIR/slomoco_matlab
export PATH=$SLOMOCO_DIR:$PATH

# if running AFNI in Linux
export AFNI_SLOMOCO_DIR=$SLOMOCO_DIR/afni_linux
# if running AFNI in MacOS
#export AFNI_SLOMOCO_DIR=$SLOMOCO_DIR/afni_mac                                       

# choose slice moco moethod: A: 3dAllineate W: 3dwarpdrive
export AFNI_SLOMOCO=W
# export AFNI_SLOMOCO=A
