...
[iVD1,iVD1z]=parallelepiped_jiang(dslimot_jiang);
[iVD2,iVD2z]=parallelepiped_jiang(dslimot_b_out_jiang);
[iVD3,iVD3z]=parallelepiped_jiang(dslimot_b_out_fit_jiang);
[iVD4,iVD4z]=parallelepiped_jiang(dvolslimot_b_out_jiang);
[iVD5,iVD5z]=parallelepiped_jiang(dvolslimot_b_out_fit_jiang);
...
fp=fopen('volslimot_b_out.txt','w'); fprintf(fp,'%g\t%g\t%g\t%g\t%g\t%g\n',volslimot_b_out'); fclose(fp);
fp=fopen('volslimot_b_out_fit.txt','w'); fprintf(fp,'%g\t%g\t%g\t%g\t%g\t%g\n',volslimot_b_out_fit'); fclose(fp);
...
[td_out,tdz_out]   =  parallelepiped_jiang(dslimot_jiang);
fp=fopen('slomoco.iVD1metric.txt','w'); fprintf(fp,'%g\n',td_out); fclose(fp);
fp=fopen('slomoco.iVD1zmetric.txt','w'); fprintf(fp,'%g\n',tdz_out); fclose(fp);
[td_out,tdz_out]   =  parallelepiped_jiang(dslimot_b_out_jiang);
fp=fopen('slomoco.iVD2metric.txt','w'); fprintf(fp,'%g\n',td_out); fclose(fp);
fp=fopen('slomoco.iVD2zmetric.txt','w'); fprintf(fp,'%g\n',tdz_out); fclose(fp);

[td_out,tdz_out]   =  parallelepiped_jiang(dslimot_b_out_fit_jiang);
fp=fopen('slomoco.iVD3metric.txt','w'); fprintf(fp,'%g\n',td_out); fclose(fp);
fp=fopen('slomoco.iVD3zmetric.txt','w'); fprintf(fp,'%g\n',tdz_out); fclose(fp);
[td_out,tdz_out]   =  parallelepiped_jiang(dvolslimot_b_out_jiang);
fp=fopen('slomoco.iVD4metric.txt','w'); fprintf(fp,'%g\n',td_out); fclose(fp);
fp=fopen('slomoco.iVD4zmetric.txt','w'); fprintf(fp,'%g\n',tdz_out); fclose(fp);
[td_out,tdz_out]   =  parallelepiped_jiang(dvolslimot_b_out_fit_jiang);
fp=fopen('slomoco.iVD5metric.txt','w'); fprintf(fp,'%g\n',td_out); fclose(fp);
fp=fopen('slomoco.iVD5zmetric.txt','w'); fprintf(fp,'%g\n',tdz_out); fclose(fp);
