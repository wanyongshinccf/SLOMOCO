function [meanvox,meanvoxz fd fdz]=parallelepiped_jiang(mocor_arranged)
...
for d = 2:tdim
    ...
    dx = mocor_arranged(d-1,1) - mocor_arranged(d,1);
    dy = mocor_arranged(d-1,2) - mocor_arranged(d,2);
    dz = mocor_arranged(d-1,3) - mocor_arranged(d,3); 
    
    dxr = mocor_arranged(d-1,4) - mocor_arranged(d,4);
    dyr = mocor_arranged(d-1,5) - mocor_arranged(d,5);
    dzr = mocor_arranged(d-1,6) - mocor_arranged(d,6);
    ...
    for zo=[lowz hiz]
        ...
        for yo=[lowy hiy]
            ...
            for xo=[lowx hix]
                ...
                xn=(cz*cy-sz*sx*sy)*xo + (sz*cy+cz*sx*sy)*yo - (cx*sy)*zo - dx;
                yn=        (-sz*cx)*xo +          (cz*cx)*yo +    (sx)*zo - dy;
                zn=(cz*sy+sz*sx*cy)*xo + (sz*sy-cz*sx*cy)*yo + (cx*cy)*zo - dz;
