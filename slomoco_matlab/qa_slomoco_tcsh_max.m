...
fp=fopen('slomoco.iTDmetric.tcsh_max.txt','w'); fprintf(fp,'%g\n',td_slomoco); fclose(fp);
fp=fopen('slomoco.iTDzmetric.tcsh_max.txt','w'); fprintf(fp,'%g\n',tdz_slomoco); fclose(fp);
 
% for a volumetric metric of motion corruption, use the max across slices within a volume
fp=fopen('slomoco.volumetric.iTDmetric.tcsh_max.txt','w'); fprintf(fp,'%g\n',max(reshape(td_slomoco,[zmbdim tdim]))); fclose(fp);
fp=fopen('slomoco.volumetric.iTDzmetric.tcsh_max.txt','w'); fprintf(fp,'%g\n',max(reshape(tdz_slomoco,[zmbdim tdim]))); fclose(fp);
...
saveas(gcf,'qa_slomoco_motionvectors.tcsh_max.jpg');
