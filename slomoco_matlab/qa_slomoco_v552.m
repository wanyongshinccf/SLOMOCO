...
fp=fopen('slomoco.TDmetric.ver552.txt','w'); fprintf(fp,'%g\n',td_slomoco); fclose(fp);
fp=fopen('slomoco.TDzmetric.ver552.txt','w'); fprintf(fp,'%g\n',tdz_slomoco); fclose(fp);

% for a volumetric metric of motion corruption, use the max across slices within a volume
fp=fopen('slomoco.volumetric.TDmetric.ver552.txt','w'); fprintf(fp,'%g\n',max(reshape(td_slomoco,[zmbdim tdim]))); fclose(fp);
fp=fopen('slomoco.volumetric.TDzmetric.ver552.txt','w'); fprintf(fp,'%g\n',max(reshape(tdz_slomoco,[zmbdim tdim]))); fclose(fp);
...
saveas(gcf,'qa_volslimoco_metrics.ver552.jpg');
...
saveas(gcf,'qa_slomoco_motionvectors.ver552.jpg');
